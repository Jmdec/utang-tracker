...
export default function InstallPrompt() {
  ...
  return (
    <AnimatePresence>
      {/*
        Wrapper: fixed, full-width, flexbox centering.
        pointerEvents none so it doesn't block taps outside the card.
      */}
      <div
        style={{
          position: 'fixed',
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{ margin: 0, fontWeight: 700, fontSize: '13px', color: '#1a1a2e' }}>
